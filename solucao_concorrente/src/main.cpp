...
int main(int argc, char const *argv[])
{
    ...
    if (argc != 5)
    {
        ...
        cout << "tente $ ./multimat_concorrente 2 2 caminhoA caminhoB" << endl << endl;
        exit(1);
    }
    // Passando o Tamanho das matrizes
    int size[2];
    int quantidade_threads = std::stoi(argv[2]);
    ...
    Readfiles *files = new Readfiles(argv[1], argv[3], argv[4]);
    ...
    {   
		...
		multiplicacao_threads(A, B, C, size[0], quantidade_threads);
