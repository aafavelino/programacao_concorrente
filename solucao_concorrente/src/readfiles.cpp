...
void Readfiles::escreverMatriz(std::vector< vector<int> > C)
{
	...
	std::ofstream fileC ("../matrizes/resultados da concorrente/C"+argumento+"x"+argumento+".txt");	
	if (fileC.is_open())
	{
...
{
	std::ofstream dados ("../matrizes/dados/dados_concorrente/C"+argumento+"x"+argumento+".txt");	
	if (dados.is_open())
	{
